    ...
    return Scaffold
      (
        appBar: AppBar
          ...
          title: Text('Status', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 30.0)),
          actions: <Widget>
          [
            Container
              (
                  ...
                  (
                    ...
                    [
                      Column
                        ...
                        children: <Widget>
                        [
                          Text('Total Cuti', style: TextStyle(color: Colors.blueAccent)),
                ...
                child: Column
                  (
                    ...
                    [
                      ...
                      Text('Baki Cuti', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 24.0)),
                ...
                child: Column
                  (
                    ...
                    [
                      ...
                      Padding(padding: EdgeInsets.only(bottom: 16.0)),
                      Text('Cuti', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 24.0)),
                      Text('1', style: TextStyle(color: Colors.black45)),
                      ...
                      Row
                        ...
                        [
                          Column
                            ...
                            children: <Widget>
                            [
                              Text('Average Cuti', style: TextStyle(color: Colors.green)),
                              Text('47', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0)),
                            ],
                          ),
                          DropdownButton
                            (
