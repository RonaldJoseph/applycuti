...
import 'package:flutter_app/Main/forms/form.dart';
import 'package:flutter_app/Main/forms/form_service.dart';

main() {
  runApp(new ApplyFormPage());
}
...
class ApplyFormPage extends StatefulWidget {
  ...
  @override
  _ApplyFormPageState createState() => new _ApplyFormPageState();
}

class _ApplyFormPageState extends State<ApplyFormPage> {
  final GlobalKey<ScaffoldState> _scaffoldKey = new GlobalKey<ScaffoldState>();
  final GlobalKey<FormState> _formKey = new GlobalKey<FormState>();
  List<String> _colors = <String>['', 'Red', 'Green', 'Blue', 'Black'];
  String _color = '';
